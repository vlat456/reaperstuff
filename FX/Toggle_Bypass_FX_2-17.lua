-- @description Toggle Bypass FX 2-17
-- @author drvlat
-- @version 1.0.0
-- @about
--   Toggles the bypass state for FX slots 2 to 17 (indices 1 to 16) on the selected track.
...
-- @provides
--   [main=main] Toggle_Bypass_FX_2-17.lua
...
local function main()
  ...
  -- Target range: slots 2 to 17 (indices 1 to 16)
  local limit = math.min(num_fx, 17)
  ...
  reaper.Undo_EndBlock("Toggle Bypass FX 2-17", -1)
end
