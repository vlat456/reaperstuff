-- @description Toggle Bypass FX 1-8
-- @author drvlat
-- @version 1.0.0
-- @about
--   Toggles the bypass state for the first 8 FX slots (indices 0 to 7) on the selected track.
...
-- @provides
--   [main=main] Toggle_Bypass_FX_1-8.lua
...
local function main()
  ...
  -- Target range: first 8 slots (indices 0 to 7)
  local limit = math.min(num_fx, 8)
  ...
  reaper.Undo_EndBlock("Toggle Bypass FX 1-8", -1)
end
