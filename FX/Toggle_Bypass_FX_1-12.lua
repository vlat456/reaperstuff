-- @description Toggle Bypass FX 1-12
-- @author drvlat
-- @version 1.0.0
-- @about
--   Toggles the bypass state for the first 12 FX slots (indices 0 to 11) on the selected track.
...
-- @provides
--   [main=main] Toggle_Bypass_FX_1-12.lua
...
local function main()
  ...
  -- Target range: first 12 slots (indices 0 to 11)
  local limit = math.min(num_fx, 12)
  ...
  reaper.Undo_EndBlock("Toggle Bypass FX 1-12", -1)
end
