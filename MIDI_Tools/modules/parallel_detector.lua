    ...
    for i = 1, #chords - 1 do
        ...
        for vA = 1, voices_count do
            for vB = vA + 1, voices_count do
                -- Get pitches
                local pitch_A_curr = chord_curr[vA].pitch
                local pitch_B_curr = chord_curr[vB].pitch
                
                local pitch_A_next = chord_next[vA].pitch
                local pitch_B_next = chord_next[vB].pitch
