...
local common_path = reaper.GetResourcePath() .. '/Scripts/MIDI_Tools/Legato_Tool_Common.lua'
local success = loadfile(common_path)
if not success then
    reaper.MB('Could not load common functions. Please ensure Legato_Tool_Common.lua is in the Scripts/MIDI_Tools folder.', 'Error', 0)
    return
end
dofile(common_path)
